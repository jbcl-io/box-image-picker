...
var BoxImagePicker = /** @class */ (function () {
    ...
    function BoxImagePicker(selector, options) {
        ...
        this.UpdateBoxWidths = function () {
            var $boxes = _this.ParentElement.querySelectorAll('.boximagepicker__box-container__box');
            var column_width = _this.ParentElement.clientWidth / _this.Options.grid_col;
            underscore_1.each($boxes, function ($box) {
                $box.style.width = column_width + "px";
            });
            // Update label max-width
            if (_this.Options.show_label) {
                var $labels = _this.ParentElement.querySelectorAll('.boximagepicker__box-container__label');
                underscore_1.each($labels, function ($label) {
