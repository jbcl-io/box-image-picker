    ...
    function BoxImagePicker(selector, options) {
        ...
        this.getSelected = function () {
            var res = {
                ...
                value: _this.SelectElement.querySelectorAll('option')[_this.SelectedIndex].value
            };
            return res;
        };
