...
var BoxImagePicker = /** @class */ (function () {
    ...
    function BoxImagePicker(selector, options) {
        ...
        this.BuildSingleBox = function ($option, index) {
            ...
            $box.style.width = _this.Options.box_size + "px";
            $box.style.height = _this.Options.box_size + "px";
            ...
            $image.style.width = _this.Options.box_size - (_this.Options.spacing * 2) - (_this.Options.border_size * 2) + "px";
            $image.style.height = _this.Options.box_size - (_this.Options.spacing * 2) - (_this.Options.border_size * 2) + "px";
