...
var BoxImagePicker = /** @class */ (function () {
    ...
    function BoxImagePicker(selector, options) {
        ...
        this.BuildBoxes = function () {
            ...
            _this.ParentElement.id = "boximagepicker-" + _this.id;
        ...
        this.CreateStylesheet = function () {
            ...
            _this.Stylesheet.type = 'text/css';
            _this.Stylesheet.appendChild(document.createTextNode("\n            #boximagepicker-" + _this.id + " .boximagepicker__box-container__box--selected .boximagepicker__box-container__box__image-container {\n                border-color: " + _this.Options.border_color + ";\n            }\n        "));
            var head = document.head || document.getElementsByTagName('head')[0];
            head.appendChild(_this.Stylesheet);
        };
        /**
